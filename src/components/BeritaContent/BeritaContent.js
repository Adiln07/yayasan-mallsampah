...
import Foto from "../../assets/img/mall.jpg"
  ...
  return (
    <div className='bg-[#DAD7CD]'>
        <div className="xl:w-[70em] lg:w-[60em] md:w-[45em] w-[21em] m-auto flex flex-col py-10 gap-y-10">
            <h1 className="text-center font-bold md:text-4xl lg:text-5xl text-2xl font-kanit text-[#3A5A40]">Jakarta, Daur Ulang Lebih Banyak 
dengan Mallsampah!</h1>
